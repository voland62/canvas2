...
{{
var G__11167 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11167;
continue;
}
} else
...
{var pred__11171 = cljs.core._EQ_;var expr__11172 = limit;if(cljs.core.truth_(pred__11171.call(null,1,expr__11172)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11171.call(null,2,expr__11172)))
...
var G__11174 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11175 = (limit__$1 - 1);
var G__11176 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11174;
limit__$1 = G__11175;
parts = G__11176;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11178 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11178))
{var replacement_11179 = temp__4090__auto___11178;buffer.append([cljs.core.str(replacement_11179)].join(''));
} else
{buffer.append(ch);
}
{
