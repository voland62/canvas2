...
{{
var G__11179 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11179;
continue;
}
} else
...
{var pred__11183 = cljs.core._EQ_;var expr__11184 = limit;if(cljs.core.truth_(pred__11183.call(null,1,expr__11184)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11183.call(null,2,expr__11184)))
...
var G__11186 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11187 = (limit__$1 - 1);
var G__11188 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11186;
limit__$1 = G__11187;
parts = G__11188;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11190 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11190))
{var replacement_11191 = temp__4090__auto___11190;buffer.append([cljs.core.str(replacement_11191)].join(''));
} else
{buffer.append(ch);
}
{
