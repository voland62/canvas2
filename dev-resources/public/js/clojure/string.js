...
{{
var G__22149 = cljs.core.pop.call(null,v__$1);
v__$1 = G__22149;
continue;
}
} else
...
{var pred__22153 = cljs.core._EQ_;var expr__22154 = limit;if(cljs.core.truth_(pred__22153.call(null,1,expr__22154)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__22153.call(null,2,expr__22154)))
...
var G__22156 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__22157 = (limit__$1 - 1);
var G__22158 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__22156;
limit__$1 = G__22157;
parts = G__22158;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___22160 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___22160))
{var replacement_22161 = temp__4090__auto___22160;buffer.append([cljs.core.str(replacement_22161)].join(''));
} else
{buffer.append(ch);
}
{
var G__22162 = (index + 1);
index = G__22162;
continue;
}
}
