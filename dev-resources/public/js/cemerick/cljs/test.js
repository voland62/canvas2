...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__22108 = m;var map__22108__$1 = ((cljs.core.seq_QMARK_.call(null,map__22108))?cljs.core.apply.call(null,cljs.core.hash_map,map__22108):map__22108);var line = cljs.core.get.call(null,map__22108__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__22108__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__22110 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__22110))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__22110))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_22111;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_22112 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__3408__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_22113 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__3408__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4092__auto___22114 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4092__auto___22114))
{var message_22115 = temp__4092__auto___22114;cljs.core.println.call(null,message_22115);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_22113;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_22116 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__3408__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4092__auto___22117 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4092__auto___22117))
{var message_22118 = temp__4092__auto___22117;cljs.core.println.call(null,message_22118);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_22119 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__3408__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_22119;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_22120 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__3408__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_22120;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__22121){
var ns_sym = cljs.core.first(arglist__22121);
arglist__22121 = cljs.core.next(arglist__22121);
var fixture_type = cljs.core.first(arglist__22121);
var fixture_fns = cljs.core.rest(arglist__22121);
...
{var t = temp__4092__auto__;var _STAR_testing_vars_STAR_22124 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__3408__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return v;
}
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_22124;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__22131 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__22132 = null;var count__22133 = 0;var i__22134 = 0;while(true){
if((i__22134 < count__22133))
{var v = cljs.core._nth.call(null,chunk__22132,i__22134);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__22131,chunk__22132,count__22133,i__22134,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__22131,chunk__22132,count__22133,i__22134,v))
);
} else
{}
{
var G__22135 = seq__22131;
var G__22136 = chunk__22132;
var G__22137 = count__22133;
var G__22138 = (i__22134 + 1);
seq__22131 = G__22135;
chunk__22132 = G__22136;
count__22133 = G__22137;
i__22134 = G__22138;
continue;
}
} else
{var temp__4092__auto__ = cljs.core.seq.call(null,seq__22131);if(temp__4092__auto__)
{var seq__22131__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__22131__$1))
{var c__4150__auto__ = cljs.core.chunk_first.call(null,seq__22131__$1);{
var G__22139 = cljs.core.chunk_rest.call(null,seq__22131__$1);
var G__22140 = c__4150__auto__;
var G__22141 = cljs.core.count.call(null,c__4150__auto__);
var G__22142 = 0;
seq__22131 = G__22139;
chunk__22132 = G__22140;
count__22133 = G__22141;
i__22134 = G__22142;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__22131__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__22131,chunk__22132,count__22133,i__22134,v,seq__22131__$1,temp__4092__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__22131,chunk__22132,count__22133,i__22134,v,seq__22131__$1,temp__4092__auto__))
);
} else
{}
{
var G__22143 = cljs.core.next.call(null,seq__22131__$1);
var G__22144 = null;
var G__22145 = 0;
var G__22146 = 0;
seq__22131 = G__22143;
chunk__22132 = G__22144;
count__22133 = G__22145;
i__22134 = G__22146;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_22148 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4090__auto___22149 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4090__auto___22149))
{var test_hook_22150 = temp__4090__auto___22149;test_hook_22150.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_22148;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__22151){
var namespaces = cljs.core.seq(arglist__22151);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__22152_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__22152_SHARP_));
